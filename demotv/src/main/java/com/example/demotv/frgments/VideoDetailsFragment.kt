...
import com.example.demotv.activities.MainActivity
import com.example.demotv.activities.PlaybackActivity
import com.example.demotv.preseters.CardPresenter
import com.example.demotv.preseters.DetailsDescriptionPresenter
 ...
 */
class VideoDetailsFragment : DetailsSupportFragment(), DashBoardListener {

    private var mSelectedArticle: Articles? = null
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        mSelectedArticle = activity?.intent?.extras?.getParcelable(DetailsActivity.NEWS)
    ...
    private fun initializeBackground(articles: Articles?) {
    ...
    private fun setupDetailsOverviewRow() {
        ...
        val row = DetailsOverviewRow(mSelectedArticle)
        ...
        Glide.with(requireActivity())
            .load(mSelectedArticle?.urlToImage)
            .centerCrop()
            .error(R.drawable.default_background)
...
//        row.actionsAdapter = actionAdapter
    ...
    private fun setupDetailsOverviewRowPresenter() {
        ...
        detailsPresenter.onActionClickedListener = OnActionClickedListener { action ->
            if (action.id == ACTION_WATCH_TRAILER) {
                ...
                intent.putExtra(DetailsActivity.NEWS, mSelectedArticle)
                startActivity(intent)
            } else {
    ...
    private fun setupRelatedMovieListRow() {
        ...
        val listRowAdapter = ArrayObjectAdapter(CardPresenter(this))
    ...
    private inner class ItemViewClickedListener : OnItemViewClickedListener {
        override fun onItemClicked(
            ...
            if (item is Articles) {
                ...
                intent.putExtra(resources.getString(R.string.news), mSelectedArticle)
